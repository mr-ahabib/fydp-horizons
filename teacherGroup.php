   ...
   <div>
    ...
    <br> <br><br><br><br>
        ...
        <div class="center_div1">
         ...
         <div class="middlediv" style="height: 200px;  border: 1px solid #dddddd80;
         ...
         <!-- Scrollable Text Input Box and Send Button -->
         <div class="lowerdiv">
         <div style="width: 85%;float: left;">
            <textarea class="scrollable-textbox" style="height: 150px;" placeholder="Type your message..."></textarea>
            
         </div>
         <div style="width: 5%;float: left;">
            <button class="button button2" style="background-color:blue ">Send</button>
         </div>
